# -*- coding: utf-8 -*-
"""
Created on Sun Jul  5 15:35:20 2020
...
#reading excel file        
df = pd.read_excel(df_path, 'Sheet1', dtype = {'condition':str, 'inc_ICD9':str, 'inc_ICD10':str, 'inc_PROC':str, 'exc_ICD9':str, 'exc_ICD10':str, 'exc_PROC':str})
...
#extracting condition name from df0 to give column name in sql script         
    ...
    related_word =  [w.replace('/', ',') for w in related_word]    
